...
import { formatIDR, isDarkMode, toggleTheme } from "#/lib/utils";
import {
  ArrowRightIcon,
  CaretDownIcon,
  CaretUpIcon,
    ...
    >
      ...
      >
        ...
        >
          ...
          otomatis yang tetap berjalan meskipun internet mati.
        </p>
      ...
      <section style={{ padding: "0 20px 80px", maxWidth: 1040, margin: "0 auto" }}>
        <div className="doppelrand-shell" style={{ boxShadow: "var(--shadow-lg)" }}>
              ...
              >
                <div>
                  ...
                  >
                    ...
                    >
                      <ShoppingCartIcon size={18} weight="fill" color="var(--color-brand)" /> Nota
                      Belanja (2 Item)
                    </div>
                    <span
                      className="price"
              ...
              <tbody>
                {COMPARISONS.map((c, i) => (
                  ...
                  >
                    ...
                    >
                      <span style={{ display: "inline-flex", alignItems: "center", gap: 6 }}>
                        <XCircleIcon size={18} weight="fill" color="var(--color-danger)" />{" "}
                        {c.oldWay}
                      </span>
                    </td>
                    <td
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  {isOpen ? (
                    <CaretUpIcon size={18} weight="bold" color="var(--color-brand)" />
                  ) : (
                    <CaretDownIcon size={18} weight="bold" color="var(--color-text-3)" />
                  )}
                </div>
                {isOpen && (
                  <p
...
function MockItem({
  ...
  return (
    ...
    >
      ...
      <div style={{ fontSize: 12, fontWeight: 800, color: "var(--color-text)", marginBottom: 2 }}>
        {name}
      </div>
      <div className="price" style={{ fontSize: 13, fontWeight: 800, color: "var(--color-brand)" }}>
        {formatIDR(price)}
      </div>
      <div
        style={{
          fontSize: 10,
          color: isLowStock ? "var(--color-danger-text)" : "var(--color-text-3)",
          marginTop: 4,
          fontWeight: 700,
        }}
      >
